    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" action="<?php echo _WEB_ROOT ?>/admin/products/store" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="exampleInputUsername1">Tên Sản Phẩm</label>
                        <input type="text" name="name" class="form-control" id="exampleInputUsername1" placeholder="Nhập Tên Sản Phẩm"  value="<?php echo old('name') ?>">
                        <?php echo form_error('name','<span style="color: red">','</span>') ?>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputUsername1">Giá</label>
                        <input type="text" name="price" class="form-control" id="exampleInputUsername1" placeholder="Nhập Giá Sản Phẩm"  value="<?php echo old('price') ?>">
